...
var BlotFormatter = function () {
  function BlotFormatter(quill) {
    ...
    this.onClick = function () {
      if (_this.currentSpec) {
        var overlayElement = _this.currentSpec.getOverlayElement();
        if (overlayElement) {
          var data = {};
          var style = overlayElement.getAttribute('style');
          var height = overlayElement.getAttribute('height');
          var width = overlayElement.getAttribute('height');
          data.style = style;
          data.width = width;
          data.height = height;
